...
## F. Insight A2A (scope moi)

- [ ] `/insights` cho phep upload 1-sheet CSV va bam phan tich sau.
- [ ] UI hien ro pipeline va model dang chay theo tung buoc.
- [ ] Backend luu run trace + result snapshot + fallback reason.
- [ ] Co migration cho cac bang trace/schema map/result.
